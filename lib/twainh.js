...
ref.types.struct = require("ref-struct-di")(ref);
 ...
 ****************************************************************************/
const TWH_32BIT = ["ia32", "x32", "x86"].includes(process.arch);
...
const TW_PACKED = { pack: TWH_CMP_OSX ? false : 2 };
...
const TW_INT32 = TWH_CMP_MSC ? ref.types.long : ref.types.int;

const TW_UINT8 = ref.types.uchar;
const TW_UINT16 = ref.types.ushort;
const TW_UINT32 = TWH_CMP_MSC ? ref.types.ulong : ref.types.uint;
